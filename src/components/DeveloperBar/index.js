...
export const DeveloperBar = () => {
  ...
  const onChangeLicense = () => {
    isAuth
      ...
      : dispatch({
        type: AUTH_LOGIN,
        payload: { user: { identificacion: '111111', email: 'desarrolloingenieria2@udea.edu.co' }, quiz: { name: 'Examen posgrados Test', cohort: '2020-1', expirationDate: '2020-06-30 19:00:00' } }
      })
  }
  ...
  const launchWarnWindow = async () => {
    ...
    ipcRenderer.send('show-warn', config)
  }
